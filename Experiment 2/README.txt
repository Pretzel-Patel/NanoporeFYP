...
It contains the code for Experiment 2

Its purpose is to take a large selection of codebooks, an sd, a dwell, and N, a number of trials, and then go through each codebook and create N different tx_messages, squiggles and basecalls using dorado. 
...
3. Create codebooks by running one of the relevant step_0 files.
